                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading text-primary">Mis Perfumes</div>
                            <a class="nav-link text-primary" href="views/frontoffice/perfumes">
                                <div class="sb-nav-link-icon text-primary"><i class="far fa-gem fa-lg"></i></div>
                                Aprobados
                                <div class="sb-sidenav-collapse-arrow text-primary"><i class="fas fa-angle-right"></i></div>
                            </a>
                            <a class="nav-link text-primary" href="views/frontoffice/perfumes?validar=0">
                                <div class="sb-nav-link-icon text-primary"><i class="fas fa-gem fa-lg"></i></div>
                                Pendientes
                                <div class="sb-sidenav-collapse-arrow text-primary"><i class="fas fa-angle-right"></i></div>
                            </a>
                            <a class="nav-link text-primary" href="views/frontoffice/crear_perfume" >
                                <div class="sb-nav-link-icon text-primary"><i class="far fa-gem fa-lg"></i></div>
                                Crear Perfume
                                <div class="sb-sidenav-collapse-arrow text-primary"><i class="fas fa-angle-right"></i></div>
                            </a>
